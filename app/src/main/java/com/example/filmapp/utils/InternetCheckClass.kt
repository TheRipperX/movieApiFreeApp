...
class InternetCheckClass(private val cm: ConnectivityManager): LiveData<Boolean>(){
    ...
    override fun onActive() {
        ...
        cm.registerNetworkCallback(req.build(), network)
    }
...
// org class check internet all api
